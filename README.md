...
## 5. 项目截图
### 工具主页
![DNSHE自动续期工具主页](https://via.placeholder.com/800x400?text=DNSHE+自动续期工具主页)
*主页界面简洁，一键触发续期，操作无门槛*

### 续期日志展示
![续期实时日志](https://via.placeholder.com/800x400?text=续期实时日志展示)
*实时输出续期进度，成功/失败状态清晰标注，便于排查问题*

### Cloudflare环境变量配置
![Cloudflare变量配置](https://via.placeholder.com/800x400?text=Cloudflare环境变量配置)
*密钥加密存储，安全可靠，杜绝泄露风险*
